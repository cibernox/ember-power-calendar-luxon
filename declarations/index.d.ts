...
export declare function isBetween(date: Date, start: Date, end: Date, _unit?: string, _inclusivity?: string): boolean;
export declare function diff(date1: Date, date2: Date): number;
export declare function normalizeDate(dateOrDateTime?: unknown): Date | undefined;
